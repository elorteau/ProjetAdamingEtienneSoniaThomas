                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="addClient" method="get">
                                        ...
                                        <div class="form-group">
                                            <label>Code</label>
                                            <input class="form-control" placeholder="Entrer le code du client" name="code">
                                            <p class="help-block">Exemple : 1254</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Nom</label>
                                            <input class="form-control" placeholder="Entrer le nom du client" name="nom">
                                        </div>
                                        <div class="form-group">
                                            <label>Prenom</label>
                                            <input class="form-control" placeholder="Entrer le prenom du client" name="prenom">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Adresse</label>
                                            <input class="form-control" placeholder="Entrer l'adresse du client" name="adresse">
                                        </div>
										...
										<p class="help-block">Format : jj/MM/yyyy</p>
										</div>
										<div class="form-group">
