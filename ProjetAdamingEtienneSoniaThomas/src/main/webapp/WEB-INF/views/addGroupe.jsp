                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="addGroupe">
                                        <div class="form-group">
                                            <label>Nom</label>
                                            <input class="form-control" name="nom" placeholder ="Entrer le nom du groupe">
                                            <p class="help-block">Exemple : BNP</p>
                                        </div>
                             <div class="form-group">
                                            <label>Code</label>
                                            <input class="form-control" name="code" placeholder="Entrer le code du groupe">
                                            <p class="help-block">Exemple : 1235</p>
                                        </div>
                                        <div class="form-group">
